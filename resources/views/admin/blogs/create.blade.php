...
@section('content-header')
    <h1 class="m-0 text-dark">Adding an article</h1>
    <div class="row">
        <div class="col-12">
            <div>
...
@section('breadcrumbs')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Adding an article</li>
        </ol>
    </div>
@endsection
@section('content')
    <form method="POST" action="{{ route('articles.store') }}" form="route" id="route" enctype="multipart/form-data">
        @csrf
                ...
                <div class="content-sheet__inner-block">
                    <div class="content-sheet__item">
                        ...
                        <input type="text" class="content-sheet__item-field " placeholder="Title of the article"
                            name="title" required data-title="Article title" data-language="en">
                        <input type="text" class="content-sheet__item-field" placeholder="Title of the article (LV)"
                            name="title_lv" required data-title="Article title (LV)" data-language="lv" />
                    </div>
                    <div class="content-sheet__item">
                        <label for="" class="content-sheet__item-title">Add route</label>
                        <select class="content-sheet__item-field " name="route_id" required data-title="Article route">
                    ...
                    <div class="content-sheet__item">
                        ...
                        <textarea id="editor" name="description" class="content-sheet__item-field" data-language="en"></textarea>
                        <textarea id="editor-lv" name="description_lv" class="content-sheet__item-field" data-language="lv"></textarea>
                    </div>
                    <div class="content-sheet__item">
                    ...
                    <div class="content-sheet__item">
                        ...
                        <label class="form__container" id="upload-container">
                            ...
                            <input class="form__file" id="upload-files" type="file" accept="video/*" name="videos[]"
                                multiple required data-title="Article videos">
                        </label>
                        <div class="form__files-container" id="files-list-container"></div>
                    </div>
                </div>
                ...
                <div class="content-sheet__inner-block">
                    <div class="content-sheet__item">
                        ...
                        <input type="text" class="content-sheet__item-field" placeholder="Title of the story"
                            name="story[1][title]" required data-title="Story 1 title" data-language="en">
                        <input type="text" class="content-sheet__item-field" placeholder="Title of the story (LV)"
                            name="story[1][title_lv]" required data-title="Story 1 title (LV)" data-language="lv">
                    </div>
                    ...
                    <div class="content-sheet__item">
                        ...
                        <input type="text" class="content-sheet__item-field" placeholder="Description of the story"
                            name="story[1][description]" required data-title="Story 1 description" data-language="en">
                        <input type="text" class="content-sheet__item-field"
                            placeholder="Description of the story (LV)" name="story[1][description_lv]" required
                            data-title="Story 1 description (LV)" data-language="lv">
                    </div>
                    ...
                    <div class="content-sheet__location-block">
                        <div class="content-sheet__item">
                            ...
                            <input type="text" class="content-sheet__item-field" placeholder="Location"
                                name="story[1][location]" required data-title="Story 1 location" data-language="en">
                            <input type="text" class="content-sheet__item-field" placeholder="Location (LV)"
                                name="story[1][location_lv]" required data-title="Story 1 location (LV)"
                                data-language="lv">
                        </div>
                    </div>
                    <div class="content-sheet__item">
                        ...
                        <label class="form__container" id="upload-container">
                            ...
                            <input class="form__file" id="upload-files" type="file" accept="image/*"
                                name="story[1][required_image]" required data-title="Story 1 image of story">
                        </label>
                        <div class="form__files-container" id="files-list-container"></div>
                    </div>
                    <div class="content-sheet__item">
                        ...
                        <label class="form__container" id="upload-container">
                            ...
                            <input class="form__file" id="upload-files" type="file" accept="video/* image/*"
                                name="story[1][video]" required data-title="Story 1 image/video">
                        </label>
                        <div class="form__files-container" id="files-list-container"></div>
                    </div>
                </div>
